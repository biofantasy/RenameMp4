...
namespace CsAtomReader
{
    ...
    public partial class AtomReader
    {
        ...
        public const string mdatTypeName = "mdat";
        public const string trakTypeName = "trak";
        public const string mdiaTypeName = "mdia";
        public const string minfTypeName = "minf";
        public const string wideTypeName = "wide";
        ...
        private static readonly List<AtomType> TypeList = new List<AtomType>
        {
            ...
            new AtomType(mdatTypeName, AtomTypeFlags.Container),
            ...
            new AtomType(trakTypeName, AtomTypeFlags.Container),
            new AtomType(mdiaTypeName, AtomTypeFlags.Container),
            new AtomType(minfTypeName, AtomTypeFlags.Container),
            new AtomType(wideTypeName, AtomTypeFlags.Tagitem),
